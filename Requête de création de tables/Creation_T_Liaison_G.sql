...
GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé  est ignorée, l''élément [dbo].[T_Liaison_G].[Id] (SqlSimpleColumn) ne sera pas renommé en Id_Liaison_G';
...
BEGIN TRANSACTION
GO
PRINT N'Création de [dbo].[T_Liaison_G]...';


GO
CREATE TABLE [dbo].[T_Liaison_G] (
    [Id_Liaison_G] INT NOT NULL,
    [Id_Activite]  INT NULL,
    [Id_Anime]     INT NULL,
    PRIMARY KEY CLUSTERED ([Id_Liaison_G] ASC)
);
